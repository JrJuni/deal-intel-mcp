...
### 10. `get_customer_themes` — 고객 고민·선정 기준 빈도
...
[Claude Desktop / Codex — 자연어 입력]
         │ stdio JSON-RPC
         ▼
[deal-intel-mcp  FastMCP 서버  10 tools]
         │
         ├── LLM Provider
